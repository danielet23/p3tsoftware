...
public class HTMLRendererVisitor extends GenericReflectiveVisitor implements AlignmentVisitor {
	...
	public void controlFile1Align(Alignment align){
		BasicAlignment alignPass = (BasicAlignment) align;
		...
		if ( align instanceof BasicAlignment && alignPass.getOntologyObject1().getFormalism() != null ) {
			writer.print("<tr><td>type:</td><td><span rel=\"align:formalism\"><span typeof=\"align:Formalism\"><span property=\"align:name\">"+alignPass.getOntologyObject1().getFormalism()+"</span><span property=\"align:uri\" content=\""+alignPass.getOntologyObject1().getFormURI()+"\"/></span></span></td></tr>");
		}
	}
	...
	public void controlFile2Align(Alignment align){
		...
		if ( align instanceof BasicAlignment && alignPass.getOntologyObject2().getFormalism() != null ) {
			writer.print("<tr><td>type:</td><td><span rel=\"align:formalism\"><span typeof=\"align:Formalism\"><span property=\"align:name\">"+alignPass.getOntologyObject2().getFormalism()+"</span><span property=\"align:uri\" content=\""+alignPass.getOntologyObject2().getFormURI()+"\"/></span></span></td></tr>");
		}
	}

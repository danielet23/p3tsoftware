...
public class AlteratorFactory {
    ...
    public Alterator cascadeAlterators( Alterator init, Properties params ) {
	Alterator modifier = init;
	// JE: Of course, this could be improved (at least be rendered generic)

		this.cascadeAlteratorsInnerA(params, modifier);
	this.cascadeAlteratorsInnerB(params, modifier);
	this.cascadeAlteratorsInnerC(params, modifier);
	/*
	...
	*/
	 ...
	 * @param modifier
	 */
	private void cascadeAlteratorsInnerA(Properties params, Alterator modifier){
	 ...
	 * @param modifier
	 */
	private void cascadeAlteratorsInnerB(Properties params, Alterator modifier){
	 ...
	 * @param modifier
	 */
	private void cascadeAlteratorsInnerC(Properties params, Alterator modifier){

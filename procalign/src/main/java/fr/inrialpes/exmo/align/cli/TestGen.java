...
public class TestGen {
    ...
    private void swhitchOpt(int c, Getopt g ){
    	switch (c) {
			case 't':
	...
	private void handleCaseD(Getopt g){
		String arg;
    	arg = g.getOptarg();
	...
	private void handleCaseMaiuscD(Getopt g){
		String arg;
		arg = g.getOptarg();
	...
	private void generateTest() throws Exception{

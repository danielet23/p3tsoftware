...
public class DiffEvaluator extends BasicEvaluator implements Evaluator {
	 ...
	 */
	private void diffInnerA(boolean has) throws AlignmentException {
		for ( Cell c1 : this.align2 ) {
			...
			has = false;
			// Reference alignment
			this.diffInnerAInner(uri1_1, uri1_2, rel1, has, c1);
			if (!has) {
	 ...
	 * @throws AlignmentException
	 */
	private void diffInnerAInner(URI uri1_1, URI uri1_2, String rel1, boolean has, Cell c1) throws AlignmentException {
	 ...
	 * @throws AlignmentException
	 */
	private void diffInnerB(boolean has) throws AlignmentException {
		for ( Cell c1 : this.align1 ) {
			...
			this.diffInnerBInner(uri1_1, uri1_2, rel1, has);
	 ...
	 * @throws AlignmentException
	 */
	private void diffInnerBInner(URI uri1_1, URI uri1_2, String rel1, boolean has) throws AlignmentException {
		for( Cell c2 : this.align2) {
			URI uri2_1 = c2.getObject1AsURI();
			URI uri2_2 = c2.getObject2AsURI();
			String rel2 = c2.getRelation().getRelation().toString();
			//this.diffInnerBInner();
			if ( (uri1_1.toString().equals(uri2_1.toString())) &&
					(uri1_2.toString().equals(uri2_2.toString())) &&
					(rel1.equals(rel2))
					) {

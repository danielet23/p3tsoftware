...
public class GroupOutput {
	 ...
	 * @param stream
	 */
	private void runIFMethodB(OutputStream stream){
		if (outFile == null) {
			stream = System.out;
		} else {
			try {
	 ...
	 * @param stream
	 */
	private void runIFMethodBInner(OutputStream stream){
		if (stream != null) {
			try {
				stream.close();
	 ...
	 * @param s
	 */
	private void runSwitchInnerB(String s){

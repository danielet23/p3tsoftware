...
public class WGroupEval {
	 ...
	 * @param params
	 */
	private void runIFMethod(Properties params){
	 ...
	 * @param listFile
	 */
	private void runForMethod(String listFile){
	 ...
	 * @param arg
	 */
    private void runSwitch(int c, Getopt g, String listFile, String arg){
		switch (c) {
			case 'h' :
				usage();
				return;
		...
		/* Debug level  */
				arg = g.getOptarg();
				this.runSwitchInnerB( arg);
				break;
			case 'w' :
		/* Use the given ontology directory */
				arg = g.getOptarg();
				this.runSwitchInnerC(arg, g);
				break;
		}
	}
	 ...
	 * @param arg
	 */
	private void runSwitchInnerA(String arg){
		if ( arg != null )  {
			color = arg.trim();
	 ...
	 * @param arg
	 */
	private void runSwitchInnerB(String arg){
	 ...
	 * @param g
	 */
	private void runSwitchInnerC(String arg, Getopt g){

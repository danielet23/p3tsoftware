...
public class NameAndPropertyAlignment extends DistanceAlignment implements AlignmentProcess {
    ...
    public void forCicleFinal(int i, int nbclass1, int nbclass2, int j, Vector<Object> classlist1, Vector<Object> classlist2, double[][] classmatrix,HeavyLoadedOntology<Object> honto1, HeavyLoadedOntology<Object> honto2) throws OntowrapException {
        for (i = 0; i < nbclass1; i++) {
    ...
    public void align(Alignment alignment, Properties params) throws AlignmentException {
        ...
        try {
            this.forCicleFinal(i,nbclass1,nbclass2,j,classlist1,classlist2,classmatrix,honto1,honto2);
        } catch (OntowrapException owex) {

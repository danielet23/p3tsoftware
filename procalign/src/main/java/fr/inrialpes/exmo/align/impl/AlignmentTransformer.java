...
public class AlignmentTransformer {
    ...
    public ObjectAlignment asObjectAlignment(URIAlignment al) throws AlignmentException, OWLOntologyChangeException {
    ...
    private ObjectAlignment asObjectAlignmentFromInstanceMatching(URIAlignment al) throws AlignmentException, OWLOntologyCreationException, OWLOntologyChangeException {
     ...
     */
    private void asObjectAlignmentDefaultInner(URIAlignment al, ObjectAlignment alignment, Object obj1, Object obj2, LoadedOntology<Object> o1, LoadedOntology<Object> o2) throws AlignmentException, OntowrapException {
        for (Cell c : al) {
            try {
            ...
            this.asObjectAlignmentDefaultInnerInner(obj1, obj2, c, alignment );
        }
    }
     ...
     * @throws AlignmentException
     */
    private void asObjectAlignmentDefaultInnerInner(Object obj1, Object obj2, Cell c, ObjectAlignment alignment) throws AlignmentException {
        if (obj1 == null)

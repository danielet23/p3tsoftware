...
public class JADEFIPAAlignmentServerOntology extends jade.content.onto.Ontology  {
  ...
  */
  private JADEFIPAAlignmentServerOntology(){ 
    ...
    // adding fields
        TermSchema term = (TermSchema)getSchema(BasicOntology.STRING);
    Schema.add(_VALUE, term, ObjectSchema.OPTIONAL);
    Schema.add(_NAME, term, ObjectSchema.OPTIONAL);
    actionSchema.add(ACTION_HASPARAMETER, Schema, 0, ObjectSchema.UNLIMITED);
    actionSchema.add(_RESULT, term, ObjectSchema.OPTIONAL);
   ...
   }catch (java.lang.Exception e) {logger.error("FATAL error", e);}
  }
  }

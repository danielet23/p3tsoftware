...
public class AlignmentService {
	...
	map.put('i', new CaseI());
	map.put('f', new CaseF());
	map.put('H', new CaseCapitalH());
	map.put('A', new CaseCapitalA());
	map.put('W', new CaseCapitalW());
	map.put('P', new CaseCapitalP());
	map.put('S', new CaseCapitalS());
	map.put('O', new CaseCapitalO());
	map.put('U', new CaseCapitalU());
	map.put('m', new CaseM());
	map.put('s', new CaseS());
	map.put('u', new CaseU());
	map.put('p', new CaseP());
	map.put('b', new CaseB());
	map.put('B', new CaseCapitalB());
	map.put('D', new CaseCapitalD());

	g = new Getopt("", args, "ho:S:l:f:d::D:H::A::W::P::O::U::m:s:u:p:b:B:i:", longopts);
	int c = g.getopt();
	...
	private class CaseI implements Handler {
		public void execute() {arg = g.getOptarg();
			try {
	...
	private class CaseCapitalH implements Handler {
		public void execute() {
			arg = g.getOptarg();
			if ( arg != null ) {
	...
	private class CaseCapitalA implements Handler {
		public void execute() {
			arg = g.getOptarg();
			if ( arg != null ) {
	...
	private class CaseCapitalW implements Handler {
		public void execute() {
			arg = g.getOptarg();
			if ( arg != null ) {
	...
	private class CaseCapitalP implements Handler {
		public void execute() {
			arg = g.getOptarg();
			if ( arg != null ) {
	...
	private class CaseCapitalS implements Handler {
		public void execute() {
			params.setProperty( "host", g.getOptarg() );
		}
	}

	private class CaseCapitalO implements Handler {
		public void execute() {
			arg = g.getOptarg();
			if ( arg != null ) {
	...
	private class CaseCapitalU implements Handler {
		public void execute() {
			arg = g.getOptarg();
			if ( arg != null ) {
	...
	private class CaseM implements Handler {
		public void execute() {
	...
	private class CaseU implements Handler {
		public void execute() {
	...
	private class CaseB implements Handler {
		public void execute() {
			dbmsparameters.setDBBASE(g.getOptarg());
		}
	}

	private class CaseCapitalB implements Handler {
		public void execute() {
			arg   = g.getOptarg();
			if ( arg != null ) {
	...
	private class CaseCapitalD implements Handler {
		public void execute() {
			arg = g.getOptarg();

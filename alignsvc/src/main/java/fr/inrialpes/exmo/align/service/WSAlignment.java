...
public class WSAlignment extends URIAlignment implements AlignmentProcess {
    final static Logger logger = LoggerFactory.getLogger( WSAlignment.class );
     ...
     public void paramaterEncoding(Properties params, String message){
	 ...
	 public void connection(HttpURLConnection httpConn , byte[] byteMess) throws AlignmentException {
		 try {
	 ...
	 public void tryCatch(HttpURLConnection httpConn) throws AlignmentException {
         try {
     ...
     public void sendReq(byte[]byteMess, HttpURLConnection httpConn) throws AlignmentException {
         try {
	 ...
	 // Parameter encoding
		 ...
		 this.paramaterEncoding(params,message);
	 ...
	 this.connection(httpConn,byteMess);

	 // Send the request through the connection

     this.sendReq(byteMess,httpConn);

	 // Get the result
	 // Parse the result in this alignment

     this.tryCatch(httpConn);
